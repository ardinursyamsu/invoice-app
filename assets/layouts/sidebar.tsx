            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li>
                <a href="/receipt" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-cash-coin"></i> <span className="ms-1 d-none d-sm-inline">Receipt</span>
                </a>
              </li>
              <li>
                <a href="/payment" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-credit-card-fill"></i> <span className="ms-1 d-none d-sm-inline">Payment</span>
                </a>
              </li>
              <li>
                <a href="/transaction" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-table"></i> <span className="ms-1 d-none d-sm-inline">Transactions</span>
                </a>
              </li>
              <li>
                <a href="/sales" className="nav-link px-0 align-middle text-white">
              ...
              <li>
                <a href="/inventory" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-grid"></i> <span className="ms-1 d-none d-sm-inline">Inventory</span>
                </a>
              </li>
              <li>
                <a href="/fixed-asset" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-grid"></i> <span className="ms-1 d-none d-sm-inline">Fixed Asset</span>
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/account" className="nav-link px-0 align-middle text-white">
                  <i className="fs-4 bi-person-lines-fill"></i> <span className="ms-1 d-none d-sm-inline">Account</span>{" "}
                </a>
              </li>
              <a href="/sub-account" className="nav-link px-0 align-middle text-white">
                <i className="fs-4 bi-person-vcard"></i> <span className="ms-1 d-none d-sm-inline">Sub-Account</span>{" "}
              </a>
              <li>
                <a href="/test" className="nav-link px-0 align-middle text-warning">
                  <i className="fs-4 bi bi-gear-fill"></i> <span className="ms-1 d-none d-sm-inline">Test</span>{" "}
                </a>
              </li>
            </ul>
            <hr />
